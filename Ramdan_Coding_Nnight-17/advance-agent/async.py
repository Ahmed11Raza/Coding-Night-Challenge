...
def get_asharib_data() -> str:
    """
    Fetches profile data about Ahmed Raza from his personal API endpoint.
    ...
    Returns:
        str: JSON string containing Ahmed's profile information
    """
...
1. Greet users warmly when they say hello (respond with 'Salam from Ahmed Raza')
2. Say goodbye appropriately when users leave (respond with 'Allah Hafiz from Ahmed Raza')
3. When users request information about Ahmed, use the get_asharib_data tool to retrieve and share his profile information
4. For any questions not related to greetings or Ahmed, politely explain: 'I'm only able to provide greetings and information about Asharib Ali. I can't answer other questions at this time.'
